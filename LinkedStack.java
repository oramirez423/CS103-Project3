...
* CSC 103 Project 3
*
* The class LinkedStack<E> allows for the creation of a LinkedStack, being able
* to push, pop, and peek items in the stack through the use of Nodes.
******************************************************************************/
...
import java.util.NoSuchElementException; //added this import statement for the new method itemAt in order to throw exception
...
public class LinkedStack<E> implements Cloneable
{
   ...
   **/   
   ...
   {
      if (top == null)
         // EmptyStackE xception is from java.util and its constructor has no argument.
         throw new EmptyStackException( );
      return top.getData( );
   }
   
   /**
   * Gets an item at the nth position without changing the stack.
   * <dt><b>Param: n </b><dd>
   *   The nth value in the stack to be retrieved.
   * <dt><b>Precondition:</b><dd>
   *   This stack is not empty and the value inputted
   *   is larger than the size of the stack.
   * <dt><b>Postcondition:</b><dd>
   *   The item in the stack at the nth position has been returned
   * <dt><b>Exception: EmptyStackException</b><dd>
   *   Indicates that this stack is empty.
   * <dt><b>Exception: IllegalStateException</b><dd>
   *   Indicates nth value is not within correct values
   **/   
   public E itemAt(int n){
      //throwing exceptions if the top node is null    
      if(top == null){
         throw new EmptyStackException();
      }
      //throwing exception if n is either greater than size or less than 0
      //as those are not valid inputs
      if(n > size() || n < 0){
      ...
      //getting the link of the node within n value
      for(int i = 0; i < n; i++){
         nod = nod.getLink();
      }
      //returning the data
